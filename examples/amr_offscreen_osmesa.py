...
image = rc.run()
yt.write_bitmap(image, "offscreen_step1_osmesa.png")

rc.scene.camera.move_forward(1.5)

image = rc.run()
yt.write_bitmap(image, "offscreen_step2_osmesa.png")

rc.scene.camera.set_position([1.0, 1.5, 3.0])
image = rc.run()
yt.write_bitmap(image, "offscreen_step3_set_position_osmesa.png")
